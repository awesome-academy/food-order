...
<div class="line"></div>
<div class="wrapper">
    {!! Form::open(['method' => 'POST', 'route' => ['editNews', $news->id], 'files' => 'true']) !!}
        <fieldset>
            <div class="widget">
                <div class="title">
                ...
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::text('title', $news->title) !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::text('description', $news->description) !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::textarea('content', $news->content, ['class' => 'form-control ckeditor', 'id' => 'demo']) !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                 <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        ...
                        <p><img id="avatar_admin" src="{{ asset(config('setting.avatar.news')) }}/{{ $news->image }}"></p>
                    </div>
                    <div class="clear"></div> 
                </div>
