...
<div class="line"></div>
<div class="wrapper">
    {!! Form::open(['method' => 'POST', 'route' => ['addUser'], 'files' => 'true']) !!}
        <fieldset>
            <div class="widget">
                <div class="title">
                ...
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::text('email') !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::password('password') !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::text('phone_number') !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::text('address') !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                    
                        <span class="oneTwo">{{ trans('setting.us') }} {!! Form::radio('level', '1') !!}</span>
                        <span class="oneTwo">{{ trans('setting.admin') }} {!! Form::radio('level', '0') !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                 <div class="formRow">                  
